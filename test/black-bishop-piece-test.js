...
describe('Black Bishop Piece Class', () => {
  describe('Default inherited properties', () => {
    ...
    it('Black Bishop Piece has a size', () => {
      expectOnPieceTest(MY_BLACK_BISHOP_PIECE).to.have.property('size');
    ...
    it('Default size is 10', () => {
      expectOnPieceTest(MY_BLACK_BISHOP_PIECE.size).to.be.equal(10);
    });
  });
  ...
  describe('Non default property values', () => {
    ...
    it('Modifies default size correctly', () => {
      expectOnPieceTest(MY_BLACK_BISHOP_PIECE.size).to.be.equal(15);
    });
  });
});
